    ...
    return (
      <div className="min-h-screen bg-gray-100 p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-xl font-bold text-center mb-8">Customer Centers</h1>
          <h1 className="text-3xl font-bold text-center text-yellow-400 mb-8"> Our Loctions</h1>
          <h1 className="text-xl font-bold text-center mb-8">Feel free to contact us with any questions</h1>
